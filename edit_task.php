...
// Get task
$taskData = $taskObj->getTask($taskId, $userId);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $taskObj->updateTask($taskId, $userId, $title, $description);
                        ...
                        <form method="POST" action="">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" 
                                       value="<?= htmlspecialchars($_POST['title'] ?? $taskData['title']) ?>" 
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" 
                                          rows="5" placeholder="Enter task description"><?= htmlspecialchars($_POST['description'] ?? $taskData['description']) ?></textarea>
                            </div>
